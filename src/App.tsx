...
function App() {
  return (
    <div className="flex flex-col items-center text-black">
      ...
      <section
        id="Home"
        className="flex justify-center bg-bgColor w-full py-28"
      >
        <div className="flex flex-col  justify-center gap-16 w-2/3">
      ...
      >
        <div className="flex flex-col w-2/3 gap-6 ">
          <div className="flex flex-col gap-2 font-semibold">
            ...
            <p className="text-2xl">Don't be shy! Hit me up! 👇</p>
          </div>
